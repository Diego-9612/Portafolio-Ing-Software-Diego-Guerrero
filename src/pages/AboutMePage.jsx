...
function AboutMePage() {
    ...
    return (
        <div
            className="h-auto pb-[10%] overflow-hidden px-[5%] md:px-[10%] mt-10 sm-mt-0"
            id="About"
        >
            <AboutMe />
                ...
                <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:gap-16 items-center">
                    <div className="space-y-6 text-center md:text-left">
                        <h2 className="text-3xl md:text-5xl font-title">
                            ...
                            <span className="block mt-2 text-blue-black dark:text-blue-white text-2xl md:text-4xl">
                                Diego Fernando Guerrero
                            </span>
                        </h2>

                        <p className="text-base md:text-lg text-blue-black dark:text-gray-400 leading-relaxed text-justify pb-4 md:pb-0">
