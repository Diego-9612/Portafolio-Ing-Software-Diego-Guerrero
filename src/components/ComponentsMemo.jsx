...
const CTAButton = memo(({ href, text, icon: Icon }) => (
    <a href={href}>
        <button className="group relative w-[160px]">
            ...
            <div className="relative h-11 bg-bg-dark backdrop-blur-xl rounded-lg border border-blue-medium/10 leading-none overflow-hidden">
                ...
                <span className="absolute inset-0 flex items-center justify-center gap-3 text-base group-hover:gap-3 transition-all duration-300">
    ...
    <a href={link} target="_blank" rel="noopener noreferrer">
        <button className="group relative p-3">
            ...
            <div className="relative rounded-xl bg-bg-dark/60 backdrop-blur-xl p-2 flex items-center justify-center border border-blue-medium/20 group-hover:border-white/20 transition-all duration-300">
                <Icon className="w-6 h-6 text-blue-medium/60 group-hover:text-white transition-colors" />
            </div>
        </button>
    </a>
));
